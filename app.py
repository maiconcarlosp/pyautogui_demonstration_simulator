...
focoMontagem('in')
montagem("robo",4, tempo=5)
montagem("robo",7, tempo=4)
montagem("foto")
montagem("robo",15, tempo=5)
montagem("robo",5, tempo=5)
montagem("robo",7, tempo=4)
montagem("foto")
montagem("robo",16, tempo=5)
montagem("robo",6, tempo=5)
montagem("robo",7, tempo=4)
montagem("foto")
montagem("robo",17,tempo=5)
focoMontagem('out')
time.sleep(2)
...
montagem("robo",7, tempo=4)
montagem("foto")
montagem("robo",9, tempo=5)
montagem("robo",5, tempo=5)
montagem("robo",7, tempo=4)
montagem("foto")
montagem("robo",10, tempo=5)
montagem("robo",6, tempo=5)
montagem("robo",7, tempo=4)
montagem("foto")
montagem("robo",11, tempo=5)
montagem("robo",18,tempo=17)
montagem("robo",19, tempo=8)
montagem("saida",22)
focoMontagem('out')
time.sleep(1)
